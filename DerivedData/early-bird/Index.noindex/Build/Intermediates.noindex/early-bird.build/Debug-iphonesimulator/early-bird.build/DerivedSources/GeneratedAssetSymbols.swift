...
extension ImageResource {
    ...
    /// The "onboardMastcot" asset catalog image resource.
    static let onboardMastcot = ImageResource(name: "onboardMastcot", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "onboardMastcot" asset catalog image.
    static var onboardMastcot: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .onboardMastcot)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "onboardMastcot" asset catalog image.
    static var onboardMastcot: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .onboardMastcot)
#else
        .init()
